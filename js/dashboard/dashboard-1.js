(function($) {
 ...
 var dzChartlist = function(){
	...
	var complaints_chart = function(){
        ...
        labels: ['Total Complaints', 'Total Saved',],
		 colors:['#ff0077', '#fff',],
        };

        var chart = new ApexCharts(document.querySelector("#complaints_chart"), options);
        chart.render();
	}

	var requests_chart = function(){
		 var options = {
          series: [85, 60],
          chart: {
          height: 350,
        ...
        var chart = new ApexCharts(document.querySelector("#requests_chart"), options);
        chart.render();
	}
